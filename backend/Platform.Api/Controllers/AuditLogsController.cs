...
{
  private readonly CrudService<AuditLog> _service;

  public AuditLogsController(CrudService<AuditLog> service)
  {
    _service = service;
  }
  ...
  [HttpPut("{id}")]
  public async Task<IActionResult> Update(string id, AuditLog item)
  {

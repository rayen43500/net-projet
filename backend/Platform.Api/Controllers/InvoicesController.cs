...
{
  private readonly CrudService<Invoice> _service;

  public InvoicesController(CrudService<Invoice> service)
  {
    _service = service;
  }
  ...
  [HttpPut("{id}")]
  public async Task<IActionResult> Update(string id, Invoice item)
  {
